...
class RandomForestConfig(ModelConfig):
    ...
    min_samples_leaf: int | None = Field(1, description="Mínimo de amostras em um nó folha")
    max_features: str | float | None = Field("sqrt", description="Máximo de features para considerar em cada split")
