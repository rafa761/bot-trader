...
class ModelConfig(BaseModel):
    ...
    description: str | None = Field(default=None, description="Descrição opcional do modelo")

class TrainingConfig(BaseModel):
    """Configuração base para treinamento"""
    test_size: float = Field(0.2, ge=0.1, le=0.5, description="Tamanho do conjunto de teste")
    random_state: int | None = Field(default=42, description="Seed para reprodutibilidade")
